...
<body>
    ...
    <form action="app.php" method="post" >
        ...
        <input type="text" placeholder="Atoti" id="fname" name="fname" >
        <!--  name attribute to pick data from the field targeted -->
        <label for="surname">Surname</label>
        <input type="text" placeholder="Mkenya" id="surname" name="surname" >

        <label for="phonenumber">Phone Number</label>
        <input type="number" placeholder="07********" id="phonenumber" name="phonenumber" >
        
        <label for="email">Email Address</label>
        <input type="text" placeholder="07********" id="email" name="email" >

        <label for="password">Password</label>
        <input type="password" placeholder="P*******d" id="password" name="password" >
