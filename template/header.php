                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            <a href="vie.php">
                                ...
                                <span class="mini-click-non">Vie</span>
                            </a>
                        </li>

                        <li>
                            <a href="vote.php" aria-expanded="false"><i class="icon nalika-new-file icon-wrap"></i>
                                <span class="mini-click-non">Vote</span></a>
                        </li>
                        <li>
                            <a href="results.php" aria-expanded="false"><i class="icon nalika-bar-chart icon-wrap"></i>
                                <span class="mini-click-non">Results</span></a>
                        </li>
                    </ul>
                </nav>
            </div>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                        ...
                                                        <span class="admin-name"><?php echo $_SESSION['firstname'], "", $_SESSION['othernames'] ?></span>
                                                        <i class="icon nalika-down-arrow nalika-angle-dw"></i>
                                                    </a>
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        <li>
                                                            <a href="index.php"><span class="icon nalika-home author-log-ic"></span>
                                                                Dashboard</a>
                                                        </li>
                                                        <li>
                                                            <a href="#"><span class="icon nalika-user author-log-ic"></span>
                                                                My Profile</a>
                                                        </li>
                                                        <li>
                                                            <a href="#"><span class="icon nalika-settings author-log-ic"></span>
                                                                Settings</a>
                                                        </li>
                                                        <li>
